...
public class Inf_Registrar_Activity extends AppCompatActivity {
    ...
    public void alta(View v){
        ...
        if(!nom.isEmpty()&&!mat.isEmpty()&&!nac.isEmpty()&&!desc.isEmpty()&&!(ima==0)) {
            ...
            Toast.makeText(this,"Todos los campos tienen que estar llenos",Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void consultapormatricula(View v){
        ...
        if(!mat.isEmpty()) {
            ...
            Toast.makeText(this,"Debes introducir la matricula del registro", Toast.LENGTH_LONG).show();
        }
    }
